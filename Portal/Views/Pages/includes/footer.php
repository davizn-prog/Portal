</div><!--corpo central de conteudos do site-->
<footer class="rodape">
    <div>
        <p>Todos os direitos reservados</p>
        <p>Estou me divertindo fazendo! :)</p>
    </div>
</footer><!--rodape-->
</div><!--um container movel verticalmente-->
</main>
<script type="text/javascript" src="<?php echo INCLUDE_PATH_STATIC ?>assets/js/main.js"></script>
<script type="text/javascript" src="<?php echo INCLUDE_PATH_STATIC ?>assets/js/home.js"></script>
