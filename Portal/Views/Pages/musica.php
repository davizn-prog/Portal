...
<section id="Musica" class="MOD-secao secao-musica" target="sec" goto=""><!-- MOD - menu-scroll -->
    ...
    <div class="container-das-playlists">
        ...
        <div class="banner-playlist hoverP" data-image="<?php echo INCLUDE_PATH_STATIC?>assets/img/temas/ocean deep digital/playlist icon2.png" data-artist="Guns N Roses" data-song="Sweet Child Of Mine" data-file="<?php echo INCLUDE_PATH_STATIC?>assets/audio/music.mp3">
    ...
    <audio id="audioplayer" style="position: absolute;left: 0; top: 0;z-index: -999;opacity: 0;"></audio><!-- tag audio pra reproduzir -->
