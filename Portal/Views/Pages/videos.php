    ...
    <div class="video-livre">
        <article class="video hoverP" name="gameplay01.mp4">
            ...
            <div class="video-bottom">
                <a href="">
                    <img class="logo-canal" src="<?php echo INCLUDE_PATH_STATIC ?>assets/img/user.png" alt="">
                </a><!--logo do canal-->
                <div class="video-bottom-detalhes">
                    <a href="" class="titulo-video">
                        JOÃO FÉLIX FAZ GOLAÇO
                    </a><!--titulo-->
                    <br>
                    <a href="" class="nome-canal">ESPN Brasil</a><!--canal-->
                    <br>
                    <a href="" class="visualizacoes">1Mi visualizações</a><!--views-->
                    <span>•</span>
                    <a href="" class="tempo-postagem">há 1 hora</a><!--tempo de postagem-->
                </div><!--dados-->
